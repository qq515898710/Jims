...
public class TbUser implements Serializable {
	 ...
	 */
	public void setTbInventoryInfo(
			java.util.Collection<TbInventoryInfo> newTbInventoryInfo) {
		removeAllTbInventoryInfo();
		for (java.util.Iterator iter = newTbInventoryInfo.iterator(); iter
				.hasNext();)
	...
	public void removeAllTbInventoryInfo() {
		if (tbInventoryInfo != null) {
			...
			for (java.util.Iterator iter = getIteratorTbInventoryInfo(); iter
					.hasNext();) {
