...
public interface GoodInfoRepository extends BaseRepository<TbGoodInfo, String> {

	public TbGoodInfo selcetByName(@Param("name") String gname);

	public int countAllByNameOrAbbreviation(@Param("name") String param);

	public List<TbGoodInfo> selectAllByNameOrAbbreviation(@Param("name") String param,
